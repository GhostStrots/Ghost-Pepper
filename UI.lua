...
do
    function GuiEngine.new(screenParent)
        ...
        self.ScreenGui.Name = "StrawberryGui"
...
local mainFrame = gui:createFrame(UDim2.new(0, 400, 0, 600), UDim2.new(0.5, -200, 0.5, -300), Color3.new(0.1, 0.1, 0.1))
...
local function createTab(name)
    local button = gui:createButton(mainFrame, UDim2.new(0, (#tabButtons * 90), 0, 80), UDim2.new(0, 80, 0, 30), name, Color3.new(0.2, 0.2, 0.2), function()
        for _, btn in pairs(tabButtons) do btn.BackgroundColor3 = Color3.new(0.2, 0.2, 0.2) end
...
local scanStatus = gui:createLabel(scannerTab, UDim2.new(0.1, 0, 0, 0), UDim2.new(0.8, 0, 0, 50), "Scan Status: Not Running", Color3.new(0, 1, 0))
...
-- Handle scanner updates (placeholder for remote events)
